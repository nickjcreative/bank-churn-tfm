...
st.set_page_config(page_title='Churn Prediction Scrolling App', layout='wide')
...
st.title('Predicción de Churn con Scrolling Storytelling')
st.subheader('Introducción')
st.write("El churn o abandono de clientes es un problema crítico en la industria bancaria. Esta app te guiará por un análisis completo mientras haces scroll.")

st.subheader('Churn General por Segmento')
...
fig3 = px.bar(x=["Probabilidad de churn"], y=[proba], color=[proba], color_continuous_scale="Reds")
st.plotly_chart(fig3)

st.subheader('Conclusión')
st.write("Hemos explorado los principales factores que influyen en el churn bancario. Este análisis permite identificar clientes en riesgo y aplicar estrategias preventivas de manera eficiente.")
